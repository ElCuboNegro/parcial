...
public class FincaRaizTest
{
    ...
    public void setupEscenario1( )
    {
        ...
        fincaRaiz.agregarInmueble( TipoInmueble.APARTAMENTO, TipoOferta.VENTA, "Bogota", "Alamos1", "Cra. 97 No. 51-51", "123456", 123.2d, 567d, imagenes );
        fincaRaiz.agregarInmueble( TipoInmueble.CASA, TipoOferta.ARRIENDO, "Cali", "Sausal", "Cra. 42 No. 51-51", "123456", 1234, 54457.d, imagenes );
        fincaRaiz.agregarInmueble( TipoInmueble.CASA, TipoOferta.VENTA, "Cartagena", "Amigos", "Cra. 38 No. 51-51", "123456", 123456.2d, 5678d, imagenes );
        fincaRaiz.agregarInmueble( TipoInmueble.APARTAMENTO, TipoOferta.VENTA, "Cali", "Alamos", "Cra. 24 No. 51-51", "123456", 1234567.2d, 56789d, imagenes );
        fincaRaiz.agregarInmueble( TipoInmueble.APARTAMENTO, TipoOferta.ARRIENDO, "Barranquilla", "Ceditros", "Cra. 16 No. 51-51", "123456", 234.2d, 678d, imagenes );
        fincaRaiz.agregarInmueble( TipoInmueble.APARTAMENTO, TipoOferta.ARRIENDO, "Pasto", "Chico", "Cra. 78 No. 51-51", "123456", 23452d, 2345.d, imagenes );
        fincaRaiz.agregarInmueble( TipoInmueble.CASA, TipoOferta.VENTA, "Tunja", "Alamos", "Cra. 35 No. 51-51", "123456", 5478.2d, 6789.d, imagenes );
        fincaRaiz.agregarInmueble( TipoInmueble.FINCA, TipoOferta.ARRIENDO, "Bogota", "Villavicencio", "Cra. 98 No. 51-51", "123456", 234567.2d, 789.d, imagenes );
        fincaRaiz.agregarInmueble( TipoInmueble.APARTAMENTO, TipoOferta.VENTA, "Bogota", "Los Rosales", "Cra. 47 No. 51-51", "123456", 345d, 7891.d, imagenes );
    }
    ...
    {
        fincaRaiz.agregarInmueble( TipoInmueble.APARTAMENTO, TipoOferta.ARRIENDO, "Bogotá", "Chico", "Cra.170 No. 71-51", "7658745", 877.2d, 88.d, new ArrayList<String>( ) );
        ArrayList<Inmueble> inmuebles = fincaRaiz.darListaInmuebles( );
