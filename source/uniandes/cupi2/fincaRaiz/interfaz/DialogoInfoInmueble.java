...
public class DialogoInfoInmueble extends JDialog implements ActionListener
{
     ...
     */
    private JComboBox<TipoInmueble> cbxTipoInmueble;

    /**
     * Texto para el tipo de oferta
     */
    private JComboBox<TipoOferta> cbxTipoOferta;
    ...
    public DialogoInfoInmueble( InterfazFincaRaiz interfazFincaRaiz )
    {
        ...
        cbxTipoOferta.setEditable(false);
        
        for(TipoOferta tipo: TipoOferta.values())
        {
        	cbxTipoOferta.addItem(tipo);
        }
        ...
        cbxTipoInmueble.setEditable( false );
        
        for(TipoInmueble tipo: TipoInmueble.values())
        {
        	cbxTipoInmueble.addItem(tipo);
        }
    ...
    public void actionPerformed( ActionEvent e )
    {
        ...
        if( cmd.equals( ACEPTAR ) )
        {
            ...
            principal.crearInmueble( cbxTipoInmueble.getItemAt(cbxTipoInmueble.getSelectedIndex()), cbxTipoOferta.getItemAt(cbxTipoOferta.getSelectedIndex()), txtCiudad.getText( ), txtBarrio.getText( ), txtDireccion.getText( ), txtTelefono.getText( ), tamanio, precio, imagenes );
            dispose( );
        }
