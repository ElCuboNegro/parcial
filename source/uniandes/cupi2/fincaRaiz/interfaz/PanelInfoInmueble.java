...
public class PanelInfoInmueble extends JPanel implements ActionListener
{
    ...
    public void actualizar( Inmueble inmueble )
    {
        if( inmueble != null )
        {
            ...
            txtPrecio.setText( "$" + valueof(inmueble.darPrecio( )));
            txtTamaño.setText( inmueble.darTamanio( ) + "" );
            txtTelefono.setText( inmueble.darTelefono( ) );
            String tipoInmueble = inmueble.darTipoInmueble().toString().charAt(0) + inmueble.darTipoInmueble( ).toString().substring(1);
            txtTipoInmueble.setText( tipoInmueble );
            String tipoOferta = inmueble.darTipoOferta().toString().charAt(0) + inmueble.darTipoOferta().toString().substring(1);
    ...
    private String valueof(double darPrecio) {
		return String.valueOf(darPrecio);
	}
